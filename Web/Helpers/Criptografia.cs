...
namespace Web.Helpers
{
    public class Criptografia
    {
        ...
        private SymmetricAlgorithm _algorithm; /// Inicialização do vetor do algoritmo simétrico
        ...
        {
            string salt = string.Empty;// Ajusta o tamanho da chave se necessário e retorna uma chave válida
